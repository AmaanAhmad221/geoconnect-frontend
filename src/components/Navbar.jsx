...
const Navbar = () => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-gray-100 shadow-sm">
      <div className="container-custom">
        <div className="h-20 flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-3 group">
            <div
              className="w-11 h-11 rounded-2xl bg-blue-100
      ...
      hover:text-red-700 transition flex items-center gap-1"
              >
                <Shield size={15} />
                Admin
              </Link>
          ...
          <div className="container-custom py-5 flex flex-col gap-3">
            ...
            {isAdmin && (
              <Link
                to="/admin"
                onClick={() => setMenuOpen(false)}
                className="mobile-link text-red-500 flex items-center gap-2"
              >
                <Shield size={15} />
                Admin Panel
              </Link>
